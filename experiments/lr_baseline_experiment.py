...
NOTE:
This script was used for initial baseline experiments during early development.
It is not required to reproduce the results in the report.

All final results are generated by `main.py`, which runs the complete experimental pipeline for both Logistic Regression and DistilBERT under a unified setup with varying shortcut strength.
"""
