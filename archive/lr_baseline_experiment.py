"""
Baseline experiment: Logistic Regression with shortcut bias.

NOTE:
This script was used for initial experiments.
Final results in the report are based on `main.py`,
which evaluates both Logistic Regression and DistilBERT
under a unified setup with varying shortcut strength.
"""
...
plt.savefig("results/lr_shortcut_analysis.png")
plt.show()

print("\nPlot saved to results/lr_shortcut_analysis.png")
print("\nDone.")